...
ggplot(Sem_histo,  aes(CosSim, fill=Age3))+geom_density(aes(y=..scaled..), alpha=0.2, adjust= 2) + theme(aspect.ratio = 0.7, axis.text=element_text(size=7, angle = 45)) +xlab("Cosine similarity") +ylab("Count")
